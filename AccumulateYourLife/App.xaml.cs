...
using AccumulateYourLife.ViewModels;
...
namespace AccumulateYourLife
{
    public partial class App : Application
    {
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            if(PhoneApplicationService.Current.State.ContainsKey("LoginInfo"))
            {
                StaticClass.network = PhoneApplicationService.Current.State["LoginInfo"] as NetWork;
            }
        }
        ...
        private void Application_Deactivated(object sender, DeactivatedEventArgs e)
        {
            ...
            {
                PhoneApplicationService.Current.State["LoginInfo"] = StaticClass.network;
